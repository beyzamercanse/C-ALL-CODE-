...
// s1 += " mercan" -> beyza mercan

// cin >> only accept until space --> beyza mercan, =>beyza
// cin.getline(s1, 11)     or    getline(cin,s1) ==> read the entire line until \n,,,,  beyza mercan , => beyza mercan
...
// Initialization
   ...
   cout << "s7 is initialized to: " << s7 << endl; // XXXXXXXXXXXXXXX
