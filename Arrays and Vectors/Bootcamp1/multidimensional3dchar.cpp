...
int main(){
    ...
    */
    ...
    for (size_t i=0 ; i < sizeof(members)/sizeof(members[0]) ; ++i){ //row
        
        for (size_t j=0 ; j < (sizeof(members[0])/sizeof(members[0][0])) ; ++j){ //col
    ...
    Printing out character by character manually : 
    John
    Samuel
    Rashid
    Rodrigez
...
int main() {
    ...
    // Read and print data from an array of strings
